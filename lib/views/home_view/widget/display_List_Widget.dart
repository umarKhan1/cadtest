                    ...
                    return Column(
                      ...
                      children: [
                          ...
                          children: [
                            Row(
                              children: [
                                InkWell(
                                  onTap: () {
                                    if (value.urlModel[totallenindex].status ==
                                        true) {
                                      setState(() {
                                ...
                                InkWell(
                                  ...
                                  child: FancyShimmerImage(
                                      ...
                                      errorWidget: Image.network(
                                          AppStrings.error_String),
                                      imageUrl:
                                          AppStrings.Caption____Image___String),
                                ),
                              ],
                            ),
                            const SizedBox(
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: ((context, index) {
                                    return Row(
                                      children: [
                                        if (value.urlModel[totallenindex].id ==
                        ...
                        value.captionString.isEmpty
                            ? Container()
                            : value.captionString[totallenindex].status == false
                                ? Container()
                                : Text(
                                    value.captionString[totallenindex].captions
                                        .toString(),
                                    style: TextStyle(
                                        color: Theme.of(context).primaryColor),
                                  ),
